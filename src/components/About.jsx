...
const About = () => {
  ...
  👨‍💻 Hi, I'm Archit123 Gupta, an Engineering Student 🎓 with a passion for Data Analyst tools and also building both dynamic front-end interfaces and robust back-end systems. I specialize in full-stack development using the MEAN and MERN stacks 🚀, and I have a strong foundation in Data Analyst ,Data Structures & Algorithms (DSA) with C++ and efficient data handling using SQL.  
